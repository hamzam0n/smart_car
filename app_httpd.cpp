...
extern int humSensor ;
extern int gasSensor ;
extern int distance ;
extern int usingUltraSonic = 0 ;
...
static esp_err_t cmd_handler(httpd_req_t *req){
    ...
    else if (!strcmp(variable, "ultra")) // modified by me  for letting auto-drive
    {
       usingUltraSonic = val ;
    }
...
<html>
    ...
    <body>
    <div align=center> <img id="streaming" src="" style='width:300px; transform:rotate(180deg);'></div>
    <br/>
    <br/>
    <div align=center> 
      <button class="button" id="start_streaming" onclick="document.getElementById('streaming').src = document.location.origin + ':81/stream'">Start Streaming</button>
    </div>
    <br/>
    <br/>
    <div align=center> 
...
static esp_err_t gas_handler(httpd_req_t *req){
    
 //   float num =  dht.readTempC() ;    
    char cstr[5];
    sprintf(cstr, "%05d", gasSensor);
    
    httpd_resp_set_type(req, "text/html");
    return httpd_resp_send(req, cstr , 10 );
}
...
void startCameraServer(){
   ...
   httpd_uri_t stream_uri = {
    ...
    if (httpd_start(&camera_httpd, &config) == ESP_OK) {
        ...
        httpd_register_uri_handler(camera_httpd, &gas_uri);
